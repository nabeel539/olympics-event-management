...
const AdminDashboard = () => {
  ...
  return (
    ...
    //               hasResults ? "bg-white" : "bg-gray-100"
    //             }`} // Different background color based on result availability
    //           >
    ...
    //                             className="text-gray-800 flex items-center p-2 bg-green-200 border-b-0 border-gray-400 rounded-sm m-1"
    //                           >
    //                             {placeImage && (
    //                               <img
    //                                 src={placeImage}
